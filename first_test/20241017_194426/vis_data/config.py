...
test_dataloader = dict(
    ...
    dataset=dict(
        data_prefix=dict(
            ...
            seg_map_path='annotations/test_annotations.coco'),
        data_root='/content/mmsegmentation/data/TumorSeg_brain',
        pipeline=[
...
train_dataloader = dict(
    ...
    dataset=dict(
        data_prefix=dict(
            ...
            seg_map_path='annotations/train_masks'),
        data_root='/content/mmsegmentation/data/TumorSeg_brain',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        data_prefix=dict(
            img_path='images/valid',
            seg_map_path='annotations/valid_annotations.coco'),
        data_root='/content/mmsegmentation/data/TumorSeg_brain',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(max_size=2560, scale=(
...
work_dir = '/content/mmsegmentation/first_test'
